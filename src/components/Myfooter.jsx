            ...
            <div className='container mx-auto py-5 ' data-aos="zoom-in-up">
                <div className='d-flex justify-content-center align-items-center mx-auto flex-column '>
                    ...
                    <ul className='d-flex align-items-center gap-4 pt-3'>
                        <li>
                            <a
                                className="text-white op-70 ff-roboto fs-xs fw-normal nav_line position-relative"
                                href="#home"
                            >
                                Home
                            </a>
                        ...
                        <li>
                            <a
                                className="text-white op-70 ff-roboto fs-xs nav_line fw-normal  position-relative"
                                href="#roadmap"
                            >
                                Roadmap
                            </a>
                        </li>
                        <li><a className="text-white op-70 ff-roboto fs-xs nav_line fw-normal position-relative"
                            href="#team">
                            Team
                        </a>
                        </li>
                    ...
                    <div className='d-flex align-items-center gap-3 pt-4'>
                        <a href="https://twitter.com/i/flow/login?input_flow_data=%7B%22requested_variant%22%3A%22eyJsYW5nIjoiZW4ifQ%3D%3D%22%7D" target='_blank'>
                            <div className='svgcircle  d-flex align-items-center justify-content-center'>
